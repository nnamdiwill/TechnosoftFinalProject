...
//ConfigReader configReader2 = new ConfigReader();
    ...
    String url2 = "https://www.google.com/gmail/about/#";
   ...
   // private By displayMaxTemp = By.xpath("//div[@class='dayDetails revealed']//span[@class='lowTemp swip']following-sibling::span[@class='temp']");
    ...
    private By registerButtonforDarksky = By.xpath("//button[@type='submit']");
    private By signUPForDarkSkyAPI = By.xpath("//a[@class='button filled']");
...
//        List<Integer> tempList = new ArrayList<>();
   ...
   public int getMaxVlue(){
    ...
    public void clickOnDarkSkyAPIBanner(){
        ...
        clickOn(signUPForDarkSkyAPI);
    }

    public void putInuserPWandclickRegister(){
        setValue("Kkodes345q@gmail.com",usernameInputDarkSkySignup);
        setValue("Xsaw32222",inputPW);
        setValue("Xsaw32222",confirmPWDarSkyAPI);

        clickOn(registerButtonforDarksky);
//        driver2.quit();
        SharedSD.getDriver().navigate().to(url2);

    }
//    public void switchFromDarkSkytoGoogle(){
//        driver2 = new ChromeDriver();
//
//        driver2.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//        driver2.get(configReader2.getUrl2());
//    }
