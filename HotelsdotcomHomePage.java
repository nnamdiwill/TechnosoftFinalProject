...
public void showStarsForHotels(By locator) {

    List<WebElement> fourStarHotelsList = SharedSD.getDriver().findElements(locator);
...
public void verifyHiltionHotelIsDisplayed(){
    ...
    if(hiltonVerify.toLowerCase().contains("hilton")){
